...
export const copyMenuTemplate = createAsyncThunk(
  ...
  async (templateId: string) => {
    try {
      ...
      const newTemplate = await axios.get(`${API_URL}/menus/${response.data.payload.id}`);
...
export const updateMenuTemplate = createAsyncThunk(
  ...
  async (template: MenuTemplate) => {
    const response = await axios.put(`${API_URL}/menus/${template.id}`, template);
...
const menuSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchAllMenuTemplates.fulfilled, (state, action: PayloadAction<MenuTemplate[]>) => {
        state.loading = false;
      ...
      .addCase(copyMenuTemplate.fulfilled, (state, action: PayloadAction<MenuTemplate>) => {
      ...
      .addCase(updateMenuTemplate.fulfilled, (state, action: PayloadAction<MenuTemplate>) => {
