      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between space-y-10 md:space-y-0">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400">Customers</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
            <li><a href="#" className="text-gray-400">How to Start</a></li>
              <li><a href="#" className="text-gray-400">Request Design ↗</a></li>
              <li><a href="#" className="text-gray-400">Menu Templates ↗</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400">Docs ↗</a></li>
              {/* <li><a href="#" className="hover:text-gray-400">Blog</a></li> */}
              <li><a href="#" className="text-gray-400">Star us on GitHub ↗</a></li>
              <li><a href="#" className="text-gray-400">Newsletter</a></li>
        ...
        <div className="mt-10 flex justify-between items-center">
          <div className="text-sm text-gray-500">© {cureentYear} MenuCraft. All rights reserved.</div>
          
          {/* Social Media Icons */}
          <div className="icons-container flex space-x-4 text-lg">
            <a href="#" className="text-gray-400"><img src="/githubIcon.svg" alt="GitHub Icon" className="h-6 w-6" /></a>
            <a href="#" className="text-gray-400"><img src="/linkedinIcon.svg" alt="LinkedIn Icon" className="h-6 w-6" /></a>
